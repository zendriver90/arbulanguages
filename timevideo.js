        ...
        if (newIndex === 0 && indexDiv >= 1 && indexDiv <= 4) {
            ...
            if (containerToRemove.length > 0) {
                containerToRemove.remove();
                            ...
                            } else if (newIndex === 0 || tablica10.length <= 3) {
                ...
                function addBackgroundToText2b(matchingFiszki2, lessonIdToShow2, matchingIndexes, aktualny) {
                        ...
                        function addBackgroundToText3(matchingFiszki3, lessonIdToShow3, matchingIndexes, currentIndexValue, aktualny) {
                            ...
                            $sentenceDiv.html(`${sentence1}<br> ${sentence2}<br> ${sentence3}`);
                                 ...
                                 let sentence3b = "";
                function addBackgroundToText3b(matchingFiszki3, lessonIdToShow3, matchingIndexes, aktualny) {
                            sentence3b = "";
                            ...
                            for (let k = 0; k < matchingFiszki3.length; k++) {
                                ...
                                // Sprawdź, czy indeks jest równy 0
                                if (aktualny) {
                                    if (matchingIndexes.includes(k + (lessonIdToShow3 - 1) * 6 + 1)) {
                                        // Sprawdzenie, czy indeks bieżącej fiszki znajduje się w tablicy matchingIndexes
                                        const spanElement = document.createElement('span');
                                        spanElement.textContent = sentencePart;
                                        spanElement.classList.add('yellow');
                            ...
                            console.log('Zawartość zmiennej sentence1:', sentence3b); // Wyświetlenie zawartości zmiennej sentence1
                            updateSentenceDiv2c();
                        }
...
console.log('tablica5', videoDuration);
...
function showCombinedSentenceForLesson3(lessonIdToShow1, lessonIdToShow2, lessonIdToShow3, fiszki, matchingIndexes, startIndex, newIndex, indexDiv, lessonsArray) {
...
function setFirstFrame2() {
    ...
    video.play();
                        ...
                        // Wywołanie funkcji zapisującej adres URL pierwszego filmu
// Wywołanie funkcji zapisującej adres URL pierwszego filmu
