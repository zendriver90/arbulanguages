$('#kasowanie').click(function() {
		...
		$('#hej').removeClass('selected1 selected2');
		$('#hejnowe').removeClass('selected3 selected4');
	$('#hejnowes').removeClass('selected5 selected6');
	$('#hejnowess').removeClass('selected7 selected8');
	$('#hejnowesss').removeClass('selected9 selected10');
	$('#hejnowessss').removeClass('selected11 selected12');
	$('#hejnowei').removeClass('selected13 selected14');
	$('#hejnoweis').removeClass('selected15 selected16');
	$('#hejnoweis').removeClass('selected17 selected18');
		...
		$('#hejnowesssi').removeClass('selected21');
		$('#hejnowesssi').removeClass('selected22');
		$('#hejnowessssi').removeClass('selected23');
		$('#hejnowessssi').removeClass('selected24');
...
$('#jQueryColorChange111111i').click(function() {
        $('#hejnowessssi').addClass('selected23');
...
$('#jQueryColorChange222222i').click(function() {
        $('#hejnowessssi').addClass('selected22');
	    $('#itemitemj').addClass('transform bordered hideBefore');
        $('#itemitem6i').removeClass('transformf bordered hideBefore');
...
$('#jQueryColorChange22222j').click(function() {
        ...
        $('#itemitem5j').removeClass('transforme bordered hideBefore');
		$('#itemitem5j').addClass('green');
		$('.Button11111j, .Button22222j').removeClass('active').addClass('inactive');
		$('.Button1k, .Button2k').removeClass('inactive').addClass('active');
...
$('#jQueryColorChange11, #jQueryColorChange22, #jQueryColorChange111, #jQueryColorChange222, #jQueryColorChange1111, #jQueryColorChange2222, #jQueryColorChange11111, #jQueryColorChange22222, #jQueryColorChange111111, #jQueryColorChange222222').prop('disabled', true);
  ...
  if (savedClasses) {
	...
	$('#itemitem5j').addClass(classes.itemitem3j);
