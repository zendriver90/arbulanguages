document.addEventListener('DOMContentLoaded', function() {
  ...
  // Obs³uga zdarzenia klikniêcia na dokument
...
// Liczba dostêpnych tekstów dla Treningu
    if (clickCount1 === 1 && zmienTekstGotowa) {
		...
		textToShow2aa2.textContent = "UCZÊ SIÊ";
    } else if (clickCount1 === 1 && zmienTekstGotowa) {
		textToShow1.classList.add("enlarged");
				textToShow1.style.backgroundImage = 'url(img/play.png)'; // Œcie¿ka do obrazka
                textToShow1.style.backgroundSize = 'contain'; // Obrazek bêdzie mieœci³ siê w kontenerze
                textToShow1.style.backgroundPosition = 'right bottom'; // Przesuniêcie obrazka w prawo i w dó³
                textToShow1.style.backgroundRepeat = 'no-repeat'; // Zapobiegnie powtarzaniu siê obrazka
                var obrazekTekstContainer = document.getElementById("obrazek-i-tekst-container");
                obrazekTekstContainer.style.paddingLeft = '10px'; // Przyk³adowe ustawienie wype³nienia dla przesuniêcia w prawo
                obrazekTekstContainer.style.paddingTop = '65px'; // Przyk³adowe ustawienie wype³nienia dla przesuniêcia w dó³
        textToShow1.textContent = 'IS';
		textToShow2.textContent = "...";
        changeText2();
		playB2();
        ...
        $('#story').addClass('hej3');
		textToShow2aa2.classList.add("enlarged2b");
		textToShow2aa2.textContent = "POWTÓRZ";
...
function changeTextaa() {
    ...
    if (clickCountaa === 0 && zmienTekstGotowaa) {
		...
		textToShowaa.style.backgroundImage = 'url(img/play.png)'; // Œcie¿ka do obrazka
                textToShowaa.style.backgroundSize = 'contain'; // Obrazek bêdzie mieœci³ siê w kontenerze
                textToShowaa.style.backgroundPosition = 'right bottom'; // Przesuniêcie obrazka w prawo i w dó³
                textToShowaa.style.backgroundRepeat = 'no-repeat'; // Zapobiegnie powtarzaniu siê obrazka
                var obrazekTekstContainer = document.getElementById("obrazek-i-tekst-container");
                obrazekTekstContainer.style.paddingLeft = '10px'; // Przyk³adowe ustawienie wype³nienia dla przesuniêcia w prawo
                obrazekTekstContainer.style.paddingTop = '65px'; // Przyk³adowe ustawienie wype³nienia dla przesuniêcia w dó³
