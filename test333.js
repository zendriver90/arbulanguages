...
<html>
 ...
 <div id="konsola" style="width: 850px;">
        ...
        <button id="osoby" onclick="przekazArgument0()" class="rodzaj-button" data-rodzaj="osoby">Wszystkie</button>
...
<button onclick="przekazArgument8('zwierzeta')" class="rodzaj-button" data-rodzaj="zwierzeta">Zwierzęta</button>
        <button onclick="przekazArgument9('czasownik')" class="rodzaj-button" data-rodzaj="czasownik">Czasowniki</button>
        <br>
...
<button id="english" onclick="wybierzCharakter('zdania')" class="charakter-button">TŁUMACZ NA ŻADANIE-OPCJONALNIE</button>
<button id="mix" onclick="wybierzCharakter('fiszki')" class="charakter-button">TYLKO PO ANGIELSKU</button>
<button id="polski" onclick="wybierzCharakter('fiszki')" class="charakter-button">TYLKO PO POLSKU</button>
        ...
        <button id="insertSlashButton" class="charakter-button">PODZIEL ZDANIA NA CZĘŚCI</button>
                <button id="insertSlashButton" class="charakter-button">WYSUŃ JEDNOCZEŚNIE W DANEJ LEKCJI</button>
<br>
...
$('.sentence1bba').html('');
            $sentenceDiv.on('click', '.left-button', function () {
                 ...
                 console.log('hej20', sentence1bba);                       
                                ...
                                $sentenceDiv.html(`<button class="left-button first-button">+<br></button>${sentence10}${sentence12}${sentence11}<br><div class="sentence1bba">${sentence1bba}</div><br><button class="left-buttonb second-button">+<br></button>${sentence20}${sentence22}<br><div class="sentence1bb1b">${sentence1bb1b}</div><br> ${sentence30}${sentence33}<br><div class="sentence1bb1c">${sentence1bb1c}</div>`);
                ...
                let sentence3b = "";
                        ...
                        sentence3b = "";
                                ...
                                const spanElement = document.createElement('span');
                                    ...
                                    sentence1bb3 = sentencePart333 + " ";
                                }
                                $sentenceDiv.html(`<button class="left-button first-button">+<br></button>${sentence10}${sentence12}${sentence11}<br><div class="sentence1bba">${sentence1bba}</div><br><button class="left-buttonb second-button">+<br></button>${sentence20}${sentence22}<br><div class="sentence1bb1b">${sentence1bb1b}</div><br><button class="left-buttonbb third-button">+<br></button> ${sentence30}${sentence33}<br><div class="sentence1bb3">${sentence1bb3}</div>`);
                               }, 0);
                                });
                        }
