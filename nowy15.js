...
`);
                    ...
                    let sentence1bba = "";
                    let sentence1bbab = "";
                    let categoryHTML = ""; // Uzyskanie HTML elementu
...
if (rodzaj === "play" && matchingFiszki1.length > 0 && matchingFiszki1[0].category3.length > 0) {
    const firstCategoryContent = matchingFiszki1[0].category3[0]; // Pierwszy element category3
    const categorySpan = document.createElement('span');
    categorySpan.textContent = firstCategoryContent;
    categorySpan.classList.add('highlight'); // Dodaj opcjonalną klasę
    categoryHTML = categorySpan.outerHTML; // Uzyskanie HTML elementu
        ...
        <div class="sentence-container">
            <span class="category-container">${categoryHTML}</span>
...
<div class="sentence1bba">${sentence1bbab}</div>
        <div class="sentence-container">
            <span class="category-container">${categoryHTML2}</span>
...
<div class="sentence1bba2">${sentence1bba2}</div>
        <div class="sentence-container">
            <span class="category-container">${categoryHTML3}</span>
...
`);
                    ...
                    let sentence1bb1b = "";
                    let sentence1bba2 = "";
                    let categoryHTML2 = ""; // Uzyskanie HTML elementu
...
// Wypisywanie wyników
                                ...
                                if (rodzaj === "play" && matchingFiszki2.length > 0 && matchingFiszki2[0].category3.length > 0) {
    const firstCategoryContent = matchingFiszki2[0].category3[0]; // Pierwszy element category3
    const categorySpan = document.createElement('span');
    categorySpan.textContent = firstCategoryContent;
    categorySpan.classList.add('highlight'); // Dodaj opcjonalną klasę
    categoryHTML2 = categorySpan.outerHTML; // Uzyskanie HTML elementu
...
`);
                    ...
                    let sentence1bb3 = "";
                    let sentence1bb1c = "";
let categoryHTML3 = ""; // Uzyskanie HTML elementu
                            ...
                            for (let lmm = 0; lmm < matchingFiszki3.length; lmm++) {
                                ...
                                for (let lmn = 0; lmn < fiszka.sentence2.length; lmn++) {
                                    ...
                                    sentence33 += sentencePart3 + " ";
                                                            ...
                                                            if (rodzaj === "play" && matchingFiszki3.length > 0 && matchingFiszki3[0].category3.length > 0) {
    const firstCategoryContent = matchingFiszki3[0].category3[0]; // Pierwszy element category3
    const categorySpan = document.createElement('span');
    categorySpan.textContent = firstCategoryContent;
    categorySpan.classList.add('highlight'); // Dodaj opcjonalną klasę
    categoryHTML3 = categorySpan.outerHTML; // Uzyskanie HTML elementu
