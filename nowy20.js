...
updateHighlight($sentence10, index, firstWord, secondWord, thirdWord, forthWord, fifthWord, sixthWord, currentFiszkaIndex);
});
...
function updateHighlight($sentence10, index, firstWord, secondWord, thirdWord, forthWord, fifthWord, sixthWord, currentFiszkaIndex) {
    ...
    $sentence10.find('.word-span').on('click', function() {
        ...
        handleWordClick(clickedIndex, indexDiv, matchingFiszki1); // Wywołanie funkcji obsługi kliknięcia
                        ...
                        console.log('hej12a', displayWordsIndex);
                                            ...
                                            function updateHighlight2(clickedIndex) {
...
.fiszka_button.fiszka_button_trening {
    border-radius: 20px;
  width: 30px;  /* Dostosuj szerokość według własnych preferencji */
  height: 20px;  /* Dostosuj wysokość według własnych preferencji */
  font-size: 25px;
  /* Dodaj inne właściwości CSS, jeśli są potrzebne */
}
.fiszka_button.fiszka_button_znam {
        border-radius: 20px;
  width: 30px;  /* Dostosuj szerokość według własnych preferencji */
  height: 20px;  /* Dostosuj wysokość według własnych preferencji */
    font-size: 25px;
...
button.story_button {
        ...
        max-width: 100%;
        box-sizing: border-box;
        height: auto; /* usuń ograniczenie wysokości */
        white-space: normal; /* pozwala tekstowi się zawijać */
}
button.story_button2 {
    border-radius: 5px;
    height: 25px;
        display: block;
    margin: 0 auto;
}
button.fiszka_button_znam {}
button.fiszka_button_trening {}

button.fiszka_button_znam.fiszka.active { background: green }
button.fiszka_button_trening.fiszka.active { background: orange }
...
.like {
    ...
    .like:hover {
        background-color: #aaa; /* Dowolny kolor tła dla efektu hover */
    }
.liked {
    background-color: white;
    color: orange;
...
.fiszka.button.story_button.active2 {
    border: 1px solid #999;
    background: orange;
    border-radius: 5px;
    text-align: center;
...
.likeIconContainer {
        width:70px;
    height:40px;
    display: inline-block; /* Ustawia ikonę i tekst obok siebie */
    vertical-align: middle; /* Wyśrodkuj ikonę względem tekstu */
}

.story_button {
    white-space: nowrap; /* Zapobiega przewijaniu tekstu */
}

.orange-button {
    background-color: orange;
    /* Dodaj inne właściwości stylu, jeśli to konieczne */
}
...
.likeIconContainer {
    font-size: 30px; /* Zmieniaj na pożądany rozmiar */
    margin-right: 5px; /* Odstęp między ikoną a licznikiem */
}
